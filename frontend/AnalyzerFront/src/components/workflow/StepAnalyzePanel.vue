...
<template>
  <WorkflowStepCard
    :step="5"
    title="大模型评估"
    description="hybrid_result + JD -> analysis"
    :task-ref-id="props.taskRefId"
    :status="props.status"
  >
    <el-descriptions :column="1" border size="small">
      <el-descriptions-item label="analyze batchSize">{{ props.batchSize }}</el-descriptions-item>
    </el-descriptions>
    <el-input-number
    ...
    />
    <el-button type="primary" :loading="props.running" @click="emit('run')">执行 Step 5</el-button>
  </WorkflowStepCard>
</template>
